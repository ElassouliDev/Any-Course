        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.lesson.update',$lesson->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea rows="6" name="description_ar"
                                              class="form-control">{{ $lesson->description_ar }}</textarea>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea rows="6" name="description_en"
                                              class="form-control">{{ $lesson->description_en }}</textarea>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="url" name="file_path" class="form-control" value="{{$lesson->file->file_path}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="course_id" class="js-example-basic-single form-control">
                                        ...
                                        @foreach($courses as $course)
                                            <option value="{{ $course->id }}" {{$lesson->course_id === $course->id ? 'selected':''}}>{{ $course['title_'.app()->getLocale()] }}</option>
