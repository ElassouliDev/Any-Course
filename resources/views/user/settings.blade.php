                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="m_tabs_3_1" role="tabpanel">
                            <form method="post" action="{{route('user.updateInfo')}}"
                                  class="update_info m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                        ...
                        <div class="tab-pane" id="m_tabs_3_2" role="tabpanel">
                            <form method="post" action="{{route('user.updatePassword')}}"
                                  class="m-form m-form--fit m-form--label-align-right update_password">
                                @csrf
                                @method('put')
                                <div class="m-portlet__body">
                                    <h3> @lang('admin.Change Password')</h3>
                                    <div class="form-group m-form__group">
                                        <label for="cpassword">
                                            @lang('admin.Current Password'):

                                        </label>
                                        <input type="password" name="current_password" id="cpassword"
                                    ...
                                    <div class="form-group m-form__group">
                                        <label for="vpassword">
                                            @lang('admin.Verify Password'):
                                        </label>
                                        <input type="password" name="new_password_confirmation" id="vpassword"
                                               class="form-control m-input"
                                               placeholder="Enter verfiy password" required>
                                        {{--                                <span class="m-form__help">
...
@push('js')
    <script type="text/javascript">
        ...
        $('.update_info input').change(function () {
        ...
        $(document).on('click', '.update_info [type="reset"]', function () {
            parent = $(this).parents('form');
            parent.find('[data_temp]').each(function (index, value) {
        ...
        $(document).on('submit', '.tab-pane.active form.update_info', function (event) {
        ...
        $(document).on('submit', '.tab-pane.active form.update_password', function (event) {
            event.preventDefault();
            var $this = $(this);
            notifications.loading.show();
            var url = $($this).attr('action');
