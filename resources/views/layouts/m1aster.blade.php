...
<head>
    ...
    <title>@yield('title','control Panel') -Courses </title>
                      ...
                      <small class="text-muted d-block mt-1">Administrator</small>
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                ...
                                <a href="{{ route('logout') }}" class="dropdown-item" onclick="event.preventDefault();
                                                 document.getElementById('logout-form').submit();">  <i class="dropdown-icon fe fe-log-out"></i> @lang('admin.sign_out')</a>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg order-lg-first">
                        <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                            <li class="nav-item">
                                <a href="{{url('admin')}}" class="nav-link"><i class="fe fe-home"></i> @lang('admin.home')</a>
                            </li>
                            @if (auth()->user()->hasPermission('read_users'))
                            <li class="nav-item">
                                <a href="javascript:void(0)" class="nav-link" data-toggle="dropdown"><i class="fe fe-users"></i> @lang('admin.users')</a>
                                <div class="dropdown-menu dropdown-menu-arrow">
                                    <a href="{{route('users.index')}}" class="dropdown-item ">@lang('admin.users')</a>
                                    <a href="{{route('users.create')}}" class="dropdown-item ">@lang('admin.create_user')</a>
                                </div>
                            </li>
                            @endif
                            @if (auth()->user()->hasPermission('read_settings'))
                            <li class="nav-item">
                                <a href="{{route('settings.index')}}" class="nav-link"><i class="fe fe-home"></i> @lang('admin.home')</a>
                            </li>
                                @endif
                        </ul>
                    </div>
