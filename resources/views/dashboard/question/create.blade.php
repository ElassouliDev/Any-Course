                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.question.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang('admin.lesson_id')</label>
                                    <select name="lesson_id" class="js-example-basic-single form-control">
                                        <option value="-1">-- @lang('admin.Selectlesson')--</option>

                                        @foreach($lessons as $lesson)
                                            <option value="{{ $lesson->id }}" >{{ $lesson['title_'.app()->getLocale()] }}</option>
